...
$(document)
        .ready(function () {
            ...
            function updateCategorySet() {
                $('.category_type').empty();
                $.ajax({
                    url: 'http://market48.toppy.in.th/api/category', dataType: 'json', type: 'GET', tryCount : 0, retryLimit : 3,
            ...
            $(document).on("click", ".post_thumbnail", function () {
                thumbnailPopup($(this).find('img'));
            });

            $(document).on("click", ".thumbnail_save_post", function () {
                thumbnailPopup($(this).find('img'));
            });
            ...
            $('.post_thumbnail_popup').on("click", function(){
              $(this).hide();
