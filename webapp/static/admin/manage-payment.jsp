            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-primary">จัดการรูปแบบช่องทางชำระเงิน</h3> </div>
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">หน้าหลัก</a></li>
                            <li class="breadcrumb-item active">จัดการรูปแบบช่องทางชำระเงิน</li>
                        </ol>
                    </div>
                </div>
                <!-- End Bread crumb -->
                    ...
                    <div class="row">
                        <div class="col-5">
                            ...
                            <div class="card card-outline-primary">
                                <form action="${ctx}/admin/manage-payment/add" method="POST" enctype="multipart/form-data">
                                    <div class="form-body">
                                        <h3 class="card-title m-t-15">เพิ่มรูปแบบการชำระเงิน</h3>
                                        <hr>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">เพิ่มไอคอน</label>
                                                    <!-- UPLOAD IMAGE -->
                                                    <div class="" id="upload_image">
                                                        <div class=" fileContainer" style="margin:0;">
                                                            <input type="file" name="paymentIcon" id="imageUpload-1" class="image-upload" required="">
                                                            <label for="imageUpload-1" class="white-button"><span><i class="fa fa-image"></i> เพิ่มรูปภาพ</span></label>
                                                        </div>


                                                        <div id="imageUpload-1-preview" class="image-preview">
                                                            <div class="image-preview-hover">
                                                                <button type="button" class="remove-image-privew"><i class="fa fa-times"></i></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- END UPLOAD IMAGE -->
                        ...
                        <div class="col-7">
                            <form action="${ctx}/admin/manage-payment/delete" method="POST">
                                <div class="card">
                                    <div class="card-body">
                                            ...
                                            <table id="myTable" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <c:forEach var="payment" items="${payments}">
                                                        <tr>
                                                            <td style="text-align:center;"><input id="delivery_checkbox_${payment.id}" type="checkbox" name="payment" value="${payment.id}">
                                                                <label for="delivery_checkbox_${payment.id}"></label></td>
                                                            <td>
                                                                <div class="img-activate-user">
                                                                    <img src="/resources/payment_logo/${payment.logo}" alt="">
                                                                </div>
                                                            </td>
