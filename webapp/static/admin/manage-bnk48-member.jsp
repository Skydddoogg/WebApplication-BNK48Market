            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-primary">จัดการชื่อสมาชิก BNK48</h3> </div>
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">หน้าหลัก</a></li>
                            <li class="breadcrumb-item active">จัดการชื่อสมาชิก BNK48</li>
                        </ol>
                    </div>
                </div>
                <!-- End Bread crumb -->
                    ...
                    <div class="row">
                        <div class="col-5">
                            ...
                            <div class="card card-outline-primary">
                                <form action="${ctx}/admin/manage-bnk48-member/add" method="POST">
                                    <div class="form-body">
                                        <h3 class="card-title m-t-15">เพิ่มสมาชิก BNK48</h3>
                                        <hr>
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">ชื่อสมาชิก</label>
                                                    <input type="text" name="name" class="form-control" placeholder="เฌอปราง">
                                                </div>
                                            </div>
                                            <!--/span-->
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="generation" class="form-control" placeholder="1">
                                                </div>
                                            </div>
                        ...
                        <div class="col-7">
                            <form action="${ctx}/admin/manage-bnk48-member/delete" method="POST">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table id="myTable" class="table table-bordered table-striped">
                                                <thead>
                                                    <tr>
                                                        <th style="text-align:center;"><input id="bnk48_member_checkbox" type="checkbox" name="type" value="111">
                                                            <label for="bnk48_member_checkbox"></label></th>
                                                        <th>ชื่อสมาชิก</th>
                                                        <th style="text-align:center;">รุ่นที่</th>
                                                ...
                                                <tbody>
                                                    <c:forEach var="member" items="${members}">
                                                        <tr>
                                                            <td style="text-align:center;"><input id="bnk48_member_checkbox_${member.id}" type="checkbox" name="deleteMember" value="${member.id}">
                                                                <label for="bnk48_member_checkbox_${member.id}"></label></td>
                                                            <td>${member.name}</td>
