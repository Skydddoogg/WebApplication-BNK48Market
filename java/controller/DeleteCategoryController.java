 ...
 * @author toppy
 */
@WebServlet(name = "DeleteCategoryController", urlPatterns = {"/admin/manage-category/delete"})
public class DeleteCategoryController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String[] deleteCategory = request.getParameterValues("deleteCategory");
        ...
        try {
            ...
            for(String category : deleteCategory){
                int cat_id = NumberFormat.toNumeric(category);
