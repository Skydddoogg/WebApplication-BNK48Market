 ...
 * @author toppy
 */
@WebServlet(name = "AddCategoryController", urlPatterns = {"/admin/manage-category/add"})
public class AddCategoryController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int super_id = NumberFormat.toNumeric(request.getParameter("super_id"));
            
            if(super_id == 0){
                sql = "INSERT INTO CATEGORY(name, super) VALUES(?,NULL)";
                pstmt = conn.prepareStatement(sql);
                pstmt.setString(1, name);
            }
            else {
                sql = "INSERT INTO CATEGORY(name, super) VALUES(?,?)";
                pstmt = conn.prepareStatement(sql);
                pstmt.setString(1, name);
                pstmt.setInt(2, super_id);
            }
